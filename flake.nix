  ...
  outputs =
    ...
    flake-parts.lib.mkFlake { inherit inputs; } (
      ...
      inputs.nixpkgs.lib.warn
        "[31mdaeuniverse/flake.nix: This branch is deprecated, it will be removed in the future. Please use `dae-release` package in `main` branch instead. See <https://github.com/daeuniverse/flake.nix/pull/124>[0m"
        {
          imports = [
